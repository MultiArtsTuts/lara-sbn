...
return [
    ...
    */
    ...
    'firebase' => [
        'api_key' => 'AIzaSyDUMgyXV2zvyqlnz3D112l80fJP26Nygkw',
        'auth_domain' => 'guia-sbn.firebaseapp.com',
        'database_url' => 'https://guia-sbn.firebaseio.com',
        'secret' => 'db secret taken from firebase',
        'storage_bucket' => 'guia-sbn.appspot.com',
    ]
];
